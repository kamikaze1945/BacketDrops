...
/**
 * Created by Dariusz on 17.10.2016.
 */

public class Divider extends RecyclerView.ItemDecoration {

    public static final String TAG = Divider.class.getCanonicalName();
    ...
    public Divider (Context context, int orientation) {
        ...
        if (orientation != LinearLayoutManager.VERTICAL) {
            throw new IllegalArgumentException("This is Decoration can by used only with a RecyclerView that uses a LinearLayoutManager with vertical orientation.");
        }
